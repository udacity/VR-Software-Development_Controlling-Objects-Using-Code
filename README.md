...
>**Note:** Contrary to best practice, the Unity project also includes one file from the project's Library folder. The reason for this is explained in the [Included Unity Library Folder Items](#included-unity-library-folder-items) section below.
